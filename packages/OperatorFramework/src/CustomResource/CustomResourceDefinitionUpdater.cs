...
public class CustomResourceDefinitionUpdater<TResource> : IHostedService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var existingList = await _client.ApiextensionsV1.ListCustomResourceDefinitionAsync(
        ...
        if (existingCustomResourceDefinition is not null)
        {
            ...
            return await _client.ApiextensionsV1.ReplaceCustomResourceDefinitionAsync(
        ...
        {
            return await _client.ApiextensionsV1.CreateCustomResourceDefinitionAsync(
                customResourceDefinition,
                cancellationToken: cancellationToken);
        }
    }

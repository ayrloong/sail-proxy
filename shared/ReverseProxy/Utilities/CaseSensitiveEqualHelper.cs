...
internal static class CaseSensitiveEqualHelper
{
    ...
    internal static bool Equals(IReadOnlyDictionary<string, string>? dictionary1,
    ...
    internal static bool Equals(IReadOnlyList<IReadOnlyDictionary<string, string>>? dictionaryList1,

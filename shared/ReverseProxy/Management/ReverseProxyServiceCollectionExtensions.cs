...
public static class ReverseProxyServiceCollectionExtensions
{
    ...
    public static IReverseProxyBuilder AddRouteExtension<T>(
        ...
        string sectionName,
        Func<IConfigurationSection, RouteConfig, T, T> factory) where T : class
    {
        builder.Services.Configure<RouteOptions>(options =>
        {
            options.RouteExtensions[sectionName] = (section, routeConfig, existing) => factory(section, routeConfig, existing as T);
        });

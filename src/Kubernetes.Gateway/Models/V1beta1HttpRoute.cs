...
public class V1beta1HttpRouteSpec
{
    ...
    [JsonProperty("rules")]
    public List<V1beta1HttpRouteRule> Rules { get; set; }
}

public class V1beta1HttpRouteRule
{
    [JsonProperty("matches")]
    public List<V1beta1HttpRouteMatch> Matches { get; set; }

    [JsonProperty("backendRefs")]
    public List<V1beta1HttpBackendRef> BackendRefs { get; set; }
}
...
public class V1beta1HttpRouteMatch
{
    ...
    [JsonProperty("path")]
    public V1beta1HttpPathMatch Path { get; set; }

    [JsonProperty("headers")]
    public V1beta1HttpHeaderMatch Headers { get; set; }

    [JsonProperty("queryParams")]
    public V1beta1HttpQueryParamMatch QueryParams { get; set; }
